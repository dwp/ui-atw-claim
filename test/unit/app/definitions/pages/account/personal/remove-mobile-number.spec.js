const page = require(
  '../../../../../../../app/definitions/pages/account/personal/remove-mobile-number');
...
describe('definitions/pages/account/personal/remove-mobile-number', () => {
    ...
    describe('returned object keys', () => {
      describe('`view` key', () => {
        ...
        it('value be a string', () => {
          ...
          assert.equal(this.result.view, 'pages/account/personal/remove-mobile-number.njk');
        });
      });
  ...
  describe('`postvalidate`', () => {
    ...
    it('if pageData.removingEntry equals yes', () => {
      ...
      sinon.assert.calledWith(setDataForPageStub.firstCall, 'new-mobile-number', {
        removingMobileNumber: 'yes'
      });
    });
