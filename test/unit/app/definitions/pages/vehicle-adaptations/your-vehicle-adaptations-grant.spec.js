const page = require('../../../../../../app/definitions/pages/vehicle-adaptations/your-vehicle-adaptations-grant');
...
describe('definitions/pages/vehicle-adaptations/your-vehicle-adaptations-grant', () => {
    ...
    describe('returned object keys', () => {
      describe('`view` key', () => {
        ...
        it('value be a string', () => {
          ...
          assert.equal(this.result.view, 'pages/vehicle-adaptations/your-vehicle-adaptations-grant.njk');
        });
      });
